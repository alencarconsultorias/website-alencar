            ...
            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6 pt-4">
                  ...
                  <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r ${beneficio.color} text-golden-primary`}>
              ...
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <div className="inline-flex p-3 bg-gray-500 rounded-full mb-4">
                    <RefreshCw className="w-6 h-6 text-golden-primary" />
                  </div>
