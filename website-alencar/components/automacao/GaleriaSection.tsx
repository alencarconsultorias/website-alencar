      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center">
            <Image src="/services/automacao/1.jpg" alt="Câmeras instaladas em residência" width={400} height={300} className="rounded-xl shadow-md object-cover" />
            <span className="text-sm mt-2 text-gray-700 text-center">Câmeras instaladas em residência</span>
          </div>
          <div className="flex flex-col items-center">
            <Image src="/services/automacao/2.png" alt="Painel de automação em empresa" width={400} height={300} className="rounded-xl shadow-md object-cover" />
            <span className="text-sm mt-2 text-gray-700 text-center">Painel de automação em empresa</span>
          </div>
          <div className="flex flex-col items-center">
            <Image src="/services/automacao/3.jpg" alt="Instalação de sensores e alarmes" width={400} height={300} className="rounded-xl shadow-md object-cover" />
